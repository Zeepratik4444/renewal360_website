			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				...
				<nav className="mb-12 p-6 bg-gray-50 rounded-lg border border-gray-200">
					...
					<div className="grid md:grid-cols-2 gap-x-8 gap-y-1 text-sm">
						...
						<a href="#pp-5" className="text-gray-600 hover:text-blue-600 py-1 pl-3">5. Microsoft 365 Account Data</a>
						<a href="#tos-10" className="text-gray-600 hover:text-blue-600 py-1 pl-3">10. Indemnification</a>
						<a href="#pp-10" className="text-gray-600 hover:text-blue-600 py-1 pl-3">10. International Data Transfers</a>
						<a href="#tos-13" className="text-gray-600 hover:text-blue-600 py-1 pl-3">13. Governing Law</a>
						<a href="#pp-11" className="text-gray-600 hover:text-blue-600 py-1 pl-3">11. GDPR & Data Subject Rights</a>
						<a href="#pp-14" className="text-gray-600 hover:text-blue-600 py-1 pl-3">14. Children's Privacy</a>
					</div>
				</nav>
					...
					<div className="space-y-8 text-gray-700 leading-relaxed">
						...
						<div>
							...
							<ul className="list-disc pl-6 mt-2 space-y-1">
								...
								<li><strong>Microsoft Graph APIs (Outlook Mail, Calendar & Teams)</strong> - Optional integration you may connect to sync Outlook email and create Teams meeting links for renewal automation; see Privacy Policy Section 5</li>
							...
							<p className="mt-2">
								...
								<a href="https://learn.microsoft.com/en-us/legal/microsoft-apis/terms-of-use" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Microsoft APIs Terms of Use</a>.
							</p>
						</div>
					...
					<div className="space-y-8 text-gray-700 leading-relaxed">
						...
						<div id="pp-4">
							...
							<p className="mt-2">
								...
								Customer Data retention practices (Section 12). You can revoke Renewal360's access to your Google Account
								at any time at{" "}
						...
						{/* PP-5 */}
						<div id="pp-5">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">5. Microsoft 365 Account Data (Outlook Mail & Teams)</h3>
							<p>
								If you choose to connect a Microsoft 365 / Outlook account to Renewal360, you will be asked to consent to
								one or more of the following Microsoft Graph API permissions, each requested only for the specific feature
							...
							<p className="mt-2">
								...
								<a href="https://learn.microsoft.com/en-us/legal/microsoft-apis/terms-of-use" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Microsoft APIs Terms of Use</a>{" "}
								and Microsoft Graph's data handling requirements. We do not use Outlook mail, calendar, or Teams meeting
								data to serve advertisements, and we do not sell or share it with third parties except to provide the
								feature you requested. Where our AI models (Section 3) process this data to generate suggestions, they
								do so in real time and do not retain it beyond the processing session, and it is never used to train
								third-party AI models.
							</p>
							<p className="mt-2">
								<strong>Human access</strong> to your Microsoft 365 data is restricted to what is necessary to operate the
								Service, and otherwise limited to: (a) instances where you have given us explicit consent, (b) where
								necessary to investigate abuse, security incidents, or violations of these Terms, or (c) where required
								to comply with applicable law. Any such access is logged and audited.
							</p>
							<p className="mt-2">
								<strong>Retention & deletion:</strong> Cached copies of Outlook/Teams data (e.g., synced email or meeting
								metadata) are retained only as long as needed to provide the connected feature, and are deleted within
								30 days of you disconnecting your Microsoft 365 account or terminating your subscription, consistent with
								our Customer Data retention practices (Section 12). You can revoke Renewal360's access to your Microsoft
								365 account at any time from{" "}
								<a href="https://myaccount.microsoft.com/organizations" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">myaccount.microsoft.com</a>{" "}
								or by asking your Microsoft 365 administrator to revoke the app's consent in the Azure/Entra admin
								center. Revoking access disables Microsoft-dependent features but does not delete Customer Data you have
								already uploaded or created within the Service.
							</p>
						</div>

						{/* PP-6 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">6. Data Storage & Security</h3>
							<p>
						...
						{/* PP-7 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">7. Data Sharing & Sub-Processors</h3>
						...
						{/* PP-8 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">8. Legal Basis for Processing (GDPR)</h3>
						...
						{/* PP-9 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">9. Your Rights</h3>
						...
						{/* PP-10 */}
						<div id="pp-10">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">10. International Data Transfers</h3>
							<p>
						...
						{/* PP-11 */}
						<div id="pp-11">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">11. GDPR & Data Subject Rights (EEA/UK)</h3>
							<p>
							...
							<p className="mt-2">
								You may exercise your data subject rights (listed in Section 9) by contacting us at{" "}
								<a href="mailto:privacy@renewal360.in" className="text-blue-600 hover:underline">privacy@renewal360.in</a>.
						...
						{/* PP-12 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">12. Data Retention</h3>
							<p>
						...
						{/* PP-13 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">13. Cookies & Tracking Technologies</h3>
						...
						{/* PP-14 */}
						<div id="pp-14">
							<h3 className="text-lg font-semibold text-gray-900 mb-2">14. Children's Privacy</h3>
							<p>
						...
						{/* PP-15 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">15. Data Breach Notification</h3>
							<p>
						...
						{/* PP-16 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">16. Changes to This Privacy Policy</h3>
							<p>
						...
						{/* PP-17 */}
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-2">17. Contact Us</h3>
							<p>
